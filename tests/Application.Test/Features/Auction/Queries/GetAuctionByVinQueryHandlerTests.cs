...
public class GetAuctionByVinQueryHandlerTests
{
    private readonly IFixture _fixture;

    public GetAuctionByVinQueryHandlerTests()
    {
    ...
    public async Task Handle_ShouldReturnNotFound_WhenAuctionDoesNotExist()
    {
        ...
        var handler = new GetAuctionByVinQueryHandler(auctionRepo.Object, vehicleRepo.Object);
        var query = _fixture.Create<GetAuctionByVinQuery>();
